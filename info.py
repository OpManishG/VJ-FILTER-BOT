...
URL = "https://speed-brt5.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://speed-brt5.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://speed-brt5.onrender.com/".format(FQDN)
else:
    URL = "https://speed-brt5.onrender.com/".format(FQDN)
