...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001742270933').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001953605234')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://opmanishg:manish123@cluster0.9zpx8h4.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp")
...
URL = "https://speedpremiumbot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://speedpremiumbot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://speedpremiumbot.onrender.com/".format(FQDN)
else:
    URL = "https://speedpremiumbot.onrender.com/".format(FQDN)
